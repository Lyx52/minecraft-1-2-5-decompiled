...
public class Texture {
   ...
   public Texture(TexturePackManager texturePackManager, OptionParser optionParser) {
   ...
   public int b(String var1) {
      ...
      if(var3 != null) {
         ...
         try {
            ...
            if(var1.startsWith("##")) {
               this.a(this.c(this.readImage(var2.readResourceAsStream(var1.substring(2)))), var6);
            } else if(var1.startsWith("%clamp%")) {
               this.b = true;
               this.a(this.readImage(var2.readResourceAsStream(var1.substring(7))), var6);
               this.b = false;
            } else if(var1.startsWith("%blur%")) {
               this.c = true;
               this.a(this.readImage(var2.readResourceAsStream(var1.substring(6))), var6);
               this.c = false;
            } else if(var1.startsWith("%blurclamp%")) {
               this.c = true;
               this.b = true;
               this.a(this.readImage(var2.readResourceAsStream(var1.substring(11))), var6);
               this.c = false;
               this.b = false;
            } else {
               InputStream var7 = var2.readResourceAsStream(var1);

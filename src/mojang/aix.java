...
public class aix {
   ...
   private int[] b = new int[17408];
   private int[] c = new int[17408];
   private int[] d = new int[17408];
   private int[] e = new int[17408];
   ...
   public aix() {
      try {
         BufferedImage var1 = ImageIO.read(aix.class.getResource("/mojang/terrain.png"));
      ...
      for(int var15 = 0; var15 < 4096; ++var15) {
         if(pb.m[var15] != null) {
            this.g[var15 * 3 + 0] = pb.m[var15].a_(1);
            this.g[var15 * 3 + 1] = pb.m[var15].a_(2);
            this.g[var15 * 3 + 2] = pb.m[var15].a_(3);
         }
      }
   ...
   public void a(mp var1) {
      ...
      if(var2 == null) {
         ...
         if(var7.g()) {
               ...
               for(int var9 = var5 - 1; var9 >= var3; --var9) {
                  ...
                  for(int var14 = 0; var14 < 128; ++var14) {
                     ...
                     if(var15 < this.f[var12] || var15 < this.f[var12 + 1]) {
                        pb var16 = pb.m[var2.a(var9, var14, var8)];
                        if(var16 == null) {
                           var13 = false;
                        } else if(var16.cd == acn.g) {
                           int var17 = var2.a(var9, var14 + 1, var8);
                           if(var17 == 0 || pb.m[var17].cd != acn.g) {
                           ...
                           if(var15 >= 0 && var15 < 544) {
                              ...
                              var26 = this.g[var16.bO * 3 + 0];
                              var27 = (var2.c(var9, var14 + 1, var8) * 0.8F + 0.2F) * var24;
                              if(var12 >= 0 && this.c[var25] <= var14) {
                                 this.c[var25] = var14;
                                 this.b[var25] = -16777216 | (int)(this.a[var26 * 3 + 0] * var27) << 16 | (int)(this.a[var26 * 3 + 1] * var27) << 8 | (int)(this.a[var26 * 3 + 2] * var27);
                              }
                              ...
                              if(var12 < 31) {
                                 ...
                                 if(this.c[var25 + 1] <= var14) {
                                    ...
                                    this.b[var25 + 1] = -16777216 | (int)(this.a[var26 * 3 + 0] * var22) << 16 | (int)(this.a[var26 * 3 + 1] * var22) << 8 | (int)(this.a[var26 * 3 + 2] * var22);
                                 }
                              }
                           }
                           ...
                           if(var15 >= -1 && var15 < 543) {
                              ...
                              var26 = this.g[var16.bO * 3 + 1];
                              var27 = var2.c(var9 - 1, var14, var8) * 0.8F + 0.2F;
                              int var21 = this.g[var16.bO * 3 + 2];
                              ...
                              if(var12 >= 0) {
                                 ...
                                 if(this.c[var25] <= var14 - 1) {
                                    ...
                                    this.b[var25] = -16777216 | (int)(this.a[var26 * 3 + 0] * var23) << 16 | (int)(this.a[var26 * 3 + 1] * var23) << 8 | (int)(this.a[var26 * 3 + 2] * var23);
                                 }
                              }
                              ...
                              if(var12 < 31) {
                                 ...
                                 if(this.c[var25 + 1] <= var14 - 1) {
                                    ...
                                    this.b[var25 + 1] = -16777216 | (int)(this.a[var21 * 3 + 0] * var23) << 16 | (int)(this.a[var21 * 3 + 1] * var23) << 8 | (int)(this.a[var21 * 3 + 2] * var23);
                                 }
                              }
                           }
                        }
            ...
            this.a();
            if(var1.a == null) {
               var1.a = new BufferedImage(32, 544, 2);
            }

            var1.a.setRGB(0, 0, 32, 544, this.b, 0, 32);
            var1.e = true;
         }
      }
   }

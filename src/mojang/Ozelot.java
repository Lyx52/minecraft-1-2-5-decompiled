...
public class Ozelot extends wd {

   private akz b;


   public Ozelot(World var1) {
      super(var1);
      ...
      this.bT.a(4, new fg(this, Player.class, 16.0F, 0.23F, 0.4F));
      ...
      this.bT.a(11, new ob(this, Player.class, 10.0F));
      this.bU.a(1, new aht(this, Chicken.class, 14.0F, 750, false));
   }
   ...
   public void b(CompundTag var1) {
      super.b(var1);
      var1.addInt("CatType", this.ad());
   }

   public void a(CompundTag var1) {
      super.a(var1);
      this.c(var1.getInt("CatType"));
   }
   ...
   public boolean b(bc var1) {
      if(var1 == this) {
         ...
         return false;
      } else if(!(var1 instanceof Ozelot)) {
         return false;
      } else {
         Ozelot var2 = (Ozelot)var1;
   ...
   public boolean i() {
      if(this.k.r.nextInt(3) == 0) {
         ...
         if(this.k.a(this.y) && this.k.a((BaseEntity)this, this.y).size() == 0 && !this.k.b(this.y)) {

...
public class Item extends BaseEntity {
   ...
   public Item(World var1, double var2, double var4, double var6, aan var8) {
      super(var1);
      this.a(0.25F, 0.25F);
      this.H = this.J / 2.0F;
   ...
   public void J_() {
      ...
      if(this.z) {
         var1 = 0.58800006F;
         int var2 = this.k.a(Utils.c(this.o), Utils.c(this.y.b) - 1, Utils.c(this.q));
         if(var2 > 0) {
   ...
   public void b(CompundTag var1) {
      var1.addShort("Health", (short)((byte)this.e));
      var1.addShort("Age", (short)this.b);
      var1.addCompundTag("Item", this.a.b(new CompundTag()));
   }

   public void a(CompundTag var1) {
      this.e = var1.getShort("Health") & 255;
      this.b = var1.getShort("Age");
      CompundTag var2 = var1.getCompundTag("Item");
      this.a = aan.a(var2);
      if(this.a == null) {
         this.A();
      }

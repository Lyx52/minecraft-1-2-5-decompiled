...
public class Wolf extends wd {
   ...
   public void b(CompundTag var1) {
      super.b(var1);
      var1.addBoolean("Angry", this.am());
   }

   public void a(CompundTag var1) {
      super.a(var1);
      this.g(var1.getBoolean("Angry"));
   }
   ...
   public void J_() {
      ...
      if(this.G()) {
         ...
         if(this.an > 0.4F) {
            ...
            int var2 = (int)(Utils.sin((this.an - 0.4F) * 3.1415927F) * 7.0F);
   ...
   public float d(float var1, float var2) {
      ...
      return Utils.sin(var3 * 3.1415927F) * Utils.sin(var3 * 3.1415927F * 11.0F) * 0.15F * 3.1415927F;
   }
   ...
   public boolean a(md var1, int var2) {
      ...
      this.a.a(false);
      if(var3 != null && !(var3 instanceof Player) && !(var3 instanceof Arrow)) {
         var2 = (var2 + 1) / 2;
      }
   ...
   public boolean c(BaseEntity var1) {
      ...
      return var1.a(md.a((Mob)this), var2);
   }

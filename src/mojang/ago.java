...
public class ago extends pb {
   ...
   public boolean e(World var1, int var2, int var3, int var4) {
      ...
      return var5 == this.bO?true:(var5 != u.bO && var5 != v.bO && var5 != E.bO?false:(var1.f(var2 - 1, var3 - 1, var4) == acn.g?true:(var1.f(var2 + 1, var3 - 1, var4) == acn.g?true:(var1.f(var2, var3 - 1, var4 - 1) == acn.g?true:var1.f(var2, var3 - 1, var4 + 1) == acn.g))));
   }

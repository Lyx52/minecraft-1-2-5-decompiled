...
public class PigZombie extends Zombie {
   ...
   public boolean i() {
      return this.k.q > 0 && this.k.a(this.y) && this.k.a((BaseEntity)this, this.y).size() == 0 && !this.k.b(this.y);
   }

   public void b(CompundTag var1) {
      super.b(var1);
      var1.addShort("Anger", (short)this.a);
   }
   ...
   public boolean a(md var1, int var2) {
      ...
      if(var3 instanceof Player) {
         List var4 = this.k.b((BaseEntity)this, this.y.b(32.0D, 32.0D, 32.0D));

         for(int var5 = 0; var5 < var4.size(); ++var5) {
            BaseEntity var6 = (BaseEntity)var4.get(var5);
            if(var6 instanceof PigZombie) {
               PigZombie var7 = (PigZombie)var6;
               var7.d(var3);
            }
         }
   ...
   private void d(BaseEntity var1) {
      this.ao = var1;

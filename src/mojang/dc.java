...
public class dc extends vp {
   ...
   public void c() {
      ...
      this.d = new ns(this);
      this.d.alist(this.s, 1, 1);
      this.e = new bx(this);
      this.e.alist(this.s, 1, 1);
      this.f = new er(this);
      this.f.alist(this.s, 1, 1);
      this.i = this.d;
      this.d();
   }
   ...
   public void d() {
      adn var1 = adn.a();
      this.s.add(new abp(0, this.q / 2 + 4, this.r - 28, 150, 20, var1.b("mojang.gui.done")));
   ...
   private void c(int var1, int var2, int var3, int var4) {
      int var5 = this.p.p.b("/mojang/gui/slot.png");

...
public class ChunkTagManager implements ChunkInterface, ua {
   ...
   public ChunkTagManager(File dimensionFile) {
   ...
   public ack a(World var1, int var2, int var3) throws IOException {
      ...
      if(var4 == null) {
         DataInputStream var10 = agp.b(this.dimensionFile, var2, var3);
         if(var10 == null) {
            return null;
         }
   ...
   private void a(ge var1) throws IOException {
      DataOutputStream var2 = agp.c(this.dimensionFile, var1.a.a, var1.a.b);
      at.writeToTag(var1.b, (DataOutput)var2);
      var2.close();
   }

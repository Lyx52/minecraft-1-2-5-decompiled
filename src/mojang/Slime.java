...
public class Slime extends Mob implements xf {
   ...
   public void b(CompundTag var1) {
      super.b(var1);
      var1.addInt("Size", this.ap() - 1);
   }

   public void a(CompundTag var1) {
      super.a(var1);
      this.d(var1.getInt("Size") + 1);
   }
   ...
   public void J_() {
      ...
      if(this.z && !var1) {
         ...
         for(int var3 = 0; var3 < var2 * 8; ++var3) {
            ...
            float var6 = Utils.sin(var4) * (float)var2 * 0.5F * var5;
            float var7 = Utils.cos(var4) * (float)var2 * 0.5F * var5;
   ...
   protected void y_() {
      this.w();
      Player var1 = this.k.b(this, 16.0D);
      if(var1 != null) {
   ...
   public void a(Player var1) {
      if(this.aj()) {
         int var2 = this.ap();
         if(this.m(var1) && (double)this.e(var1) < 0.6D * (double)var2 && var1.a(md.a((Mob)this), this.al())) {
            this.k.a(this, "mojang.mob.slimeattack", 1.0F, (this.U.nextFloat() - this.U.nextFloat()) * 0.2F + 1.0F);
         }
      }
   ...
   public boolean i() {
      ack var1 = this.k.c(Utils.c(this.o), Utils.c(this.q));

...
public class adt extends ho {

   public qp[] a = new qp[7];


   public adt() {
      this.a[0] = new qp(this, 0, 10);
      this.a[1] = new qp(this, 0, 0);
      this.a[2] = new qp(this, 0, 0);
      this.a[3] = new qp(this, 0, 0);
      this.a[4] = new qp(this, 0, 0);
      this.a[5] = new qp(this, 44, 10);
      byte var1 = 20;
      byte var2 = 8;
      byte var3 = 16;
      byte var4 = 4;

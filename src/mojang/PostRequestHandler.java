...
public class PostRequestHandler {
   ...
   public static String sendPOSTMAP(URL var0, Map var1, boolean var2) {
      return sendPOST(var0, a(var1), var2);
   }

   public static String sendPOST(URL var0, String var1, boolean var2) {
      try {

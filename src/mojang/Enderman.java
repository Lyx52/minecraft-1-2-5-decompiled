...
public class Enderman extends Monster {
   ...
   public Enderman(World var1) {
      super(var1);
      this.bm = "/mojang/mob/enderman.png";
      this.cj = 0.2F;
      this.c = 7;
      this.a(0.6F, 2.9F);
      this.R = 1.0F;
   ...
   public void b(CompundTag var1) {
      super.b(var1);
      var1.addShort("carried", (short)this.z_());
      var1.addShort("carriedData", (short)this.x());
   }

   public void a(CompundTag var1) {
      super.a(var1);
      this.g_(var1.getShort("carried"));
      this.h_(var1.getShort("carriedData"));
   }

   protected BaseEntity h() {
      Player var1 = this.k.b(this, 64.0D);
      if(var1 != null) {
         if(this.d(var1)) {
            if(this.e++ == 5) {
               this.e = 0;
   ...
   private boolean d(Player var1) {
      ...
      if(var2 != null && var2.c == pb.ba.bO) {
         ...
         bo var4 = mojang.bo.b(this.o - var1.o, this.y.b + (double)(this.J / 2.0F) - (var1.p + (double)var1.I()), this.q - var1.q);
         double var5 = var4.d();
         var4 = var4.c();
   ...
   public void e() {
      ...
      if(!this.k.F) {
         ...
         if(this.z_() == 0) {
            if(this.U.nextInt(20) == 0) {
               var1 = Utils.c(this.o - 2.0D + this.U.nextDouble() * 4.0D);
               var2 = Utils.c(this.p + this.U.nextDouble() * 3.0D);
               var3 = Utils.c(this.q - 2.0D + this.U.nextDouble() * 4.0D);
            ...
            var1 = Utils.c(this.o - 1.0D + this.U.nextDouble() * 2.0D);
            var2 = Utils.c(this.p + this.U.nextDouble() * 2.0D);
            var3 = Utils.c(this.q - 1.0D + this.U.nextDouble() * 2.0D);
            var4 = this.k.a(var1, var2, var3);
      ...
      if(this.k.m() && !this.k.F) {
         ...
         if(var6 > 0.5F && this.k.m(Utils.c(this.o), Utils.c(this.p), Utils.c(this.q)) && this.U.nextFloat() * 30.0F < (var6 - 0.4F) * 2.0F) {
            this.ao = null;
            this.u();
         }
      }
      ...
      if(!this.k.F && this.M()) {
         if(this.ao != null) {
            if(this.ao instanceof Player && this.d((Player)this.ao)) {
   ...
   protected boolean d(BaseEntity var1) {
      bo var2 = mojang.bo.b(this.o - var1.o, this.y.b + (double)(this.J / 2.0F) - var1.p + (double)var1.I(), this.q - var1.q);
      var2 = var2.c();
      double var3 = 16.0D;
   ...
   protected boolean a_(double var1, double var3, double var5) {
      ...
      this.q = var5;
      boolean var13 = false;
      int var14 = Utils.c(this.o);
      int var15 = Utils.c(this.p);
      int var16 = Utils.c(this.q);
      int var18;
      if(this.k.j(var14, var15, var16)) {
         ...
         if(var17) {
            ...
            if(this.k.a((BaseEntity)this, this.y).size() == 0 && !this.k.b(this.y)) {
               var13 = true;
            }
         }
      }
      ...
      if(!var13) {
         ...
         this.k.a(var7, var9, var11, "mojang.mob.endermen.portal", 1.0F, 1.0F);
         this.k.a(this, "mojang.mob.endermen.portal", 1.0F, 1.0F);
         return true;
      }
   }

   protected String m() {
      return "mojang.mob.endermen.idle";
   }

   protected String n() {
      return "mojang.mob.endermen.hit";
   }

   protected String o() {
      return "mojang.mob.endermen.death";
   }

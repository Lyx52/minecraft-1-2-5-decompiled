...
public final class ap {
   ...
   public void a(Reader var1, akj var2) throws IOException, ale {
   ...
   private void a(acd var1, akj var2) throws ale, IOException {
   ...
   private void b(acd var1, akj var2) throws ale, IOException {
      char var3 = (char)this.l(var1);
      if(var3 != 123) {
         throw new ale("Expected object to start with { but got [" + var3 + "].", var1);
      } else {
   ...
   private void c(acd var1, akj var2) throws ale, IOException {
      char var3 = (char)this.l(var1);
      if(34 != var3) {
   ...
   private void d(acd var1, akj var2) throws IOException, ale {
      char var3 = (char)this.l(var1);
      switch(var3) {
      case 34:
         var1.a(var3);
   ...
   private String a(acd var1) throws IOException, ale {
   ...
   private String b(acd var1) throws IOException, ale {
      StringBuilder var2 = new StringBuilder();
      char var3 = (char)var1.c();
      if(48 == var3) {
         var2.append('0');
   ...
   private char c(acd var1) throws IOException, ale {
      char var3 = (char)var1.c();
      switch(var3) {
      case 49:
      case 50:
   ...
   private char d(acd var1) throws IOException, ale {
      char var3 = (char)var1.c();
      switch(var3) {
      case 48:
      case 49:
   ...
   private String e(acd var1) throws IOException {
      StringBuilder var2 = new StringBuilder();
      boolean var3 = false;
   ...
   private String f(acd var1) throws IOException, ale {
      StringBuilder var2 = new StringBuilder();
      char var3 = (char)var1.c();
      if(var3 == 46) {
         var2.append('.');
   ...
   private String g(acd var1) throws IOException, ale {
      StringBuilder var2 = new StringBuilder();
      char var3 = (char)var1.c();
      if(var3 != 46 && var3 != 69) {
         var1.a(var3);
   ...
   private String h(acd var1) throws IOException {
      StringBuilder var2 = new StringBuilder();
      char var3 = (char)var1.c();
      if(var3 != 43 && var3 != 45) {
         var1.a(var3);
   ...
   private String i(acd var1) throws ale, IOException {
      StringBuilder var2 = new StringBuilder();
      char var3 = (char)var1.c();
      if(34 != var3) {
   ...
   private char j(acd var1) throws ale, IOException {
      char var3 = (char)var1.c();
      char var2;
      switch(var3) {
      case 34:
   ...
   private int k(acd var1) throws ale, IOException {
   ...
   private int l(acd var1) throws IOException {
      boolean var3 = false;

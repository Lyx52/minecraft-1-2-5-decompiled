...
public class alh extends rt {

   float a;


   public alh(World var1, double var2, double var4, double var6, double var8, double var10, double var12) {
      this(var1, var2, var4, var6, var8, var10, var12, 1.0F);
   }

   public alh(World var1, double var2, double var4, double var6, double var8, double var10, double var12, float var14) {
      ...
      this.s += var10;
      this.t += var12;
      this.ao = this.ap = this.aq = (float)(Math.random() * 0.30000001192092896D);
      this.am *= 0.75F;
      this.am *= var14;
      this.a = this.am;

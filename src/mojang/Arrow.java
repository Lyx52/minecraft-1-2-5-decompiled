...
public class Arrow extends BaseEntity {
   ...
   public Arrow(World var1, Mob var2, Mob var3, float var4, float var5) {
      super(var1);
      this.c = var2;
      this.a = var2 instanceof Player;
      ...
      double var12 = (double) Utils.sqrt(var6 * var6 + var10 * var10);
      if(var12 >= 1.0E-7D) {
   ...
   public Arrow(World var1, Mob var2, float var3) {
      super(var1);
      this.c = var2;
      this.a = var2 instanceof Player;
      this.a(0.5F, 0.5F);
      ...
      this.H = 0.0F;
      this.r = (double)(-Utils.sin(this.u / 180.0F * 3.1415927F) * Utils.cos(this.v / 180.0F * 3.1415927F));
      this.t = (double)(Utils.cos(this.u / 180.0F * 3.1415927F) * Utils.cos(this.v / 180.0F * 3.1415927F));
      this.s = (double)(-Utils.sin(this.v / 180.0F * 3.1415927F));
   ...
   public void J_() {
      ...
      if(var15 > 0) {
         pb.m[var15].a((WorldInterface)this.k, this.e, this.am, this.an);
      ...
      if(this.aq) {
         ...
         if(var3 != null) {
            if(var3.g != null) {
               var19 = Utils.sqrt(this.r * this.r + this.s * this.s + this.t * this.t);
               ...
               if(var3.g.a(var21, var20)) {
                  if(var3.g instanceof Mob) {
                     ++((Mob)var3.g).bQ;
                     if(this.au > 0) {
                        float var23 = Utils.sqrt(this.r * this.r + this.t * this.t);
                        if(var23 > 0.0F) {
         ...
         this.p += this.s;
         this.q += this.t;
         var19 = Utils.sqrt(this.r * this.r + this.t * this.t);
   ...
   public void b(CompundTag var1) {
      ...
      var1.addByte("inData", (byte)this.ap);
      var1.addByte("shake", (byte)this.b);
      var1.addByte("inGround", (byte)(this.aq?1:0));
      var1.addBoolean("player", this.a);
      var1.addDouble("damage", this.at);
   }
   ...
   public void a(CompundTag var1) {
      ...
      this.ap = var1.getByte("inData") & 255;
      this.b = var1.getByte("shake") & 255;
      this.aq = var1.getByte("inGround") == 1;
      this.a = var1.getBoolean("player");
      if(var1.containsKey("damage")) {
         this.at = var1.getDouble("damage");
      }

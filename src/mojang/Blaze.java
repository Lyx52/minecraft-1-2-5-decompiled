   ...
   protected void a(BaseEntity var1, float var2) {
      if(this.bE <= 0 && var2 < 2.0F && var1.y.e > this.y.b && var1.y.b < this.y.e) {
         ...
         if(this.bE == 0) {
            ...
            if(this.d > 1) {
               float var9 = Utils.sqrt(var2) * 0.5F;
               this.k.a((Player)null, 1009, (int)this.o, (int)this.p, (int)this.q, 0);

               for(int var10 = 0; var10 < 1; ++var10) {
                  SmallFireball var11 = new SmallFireball(this.k, this, var3 + this.U.nextGaussian() * (double)var9, var5, var7 + this.U.nextGaussian() * (double)var9);
                  var11.p = this.p + (double)(this.J / 2.0F) + 0.5D;
                  this.k.a((BaseEntity)var11);
               }
            }
         }

...
public class zp extends tt {
      ...
      for(int var2 = 0; var2 < 32; ++var2) {
         for(int var3 = 0; var3 < 16; ++var3) {
            for(int var4 = 0; var4 < 16; ++var4) {
               ...
               this.b[var2][var16 * 4 + 0] = (byte)var13;
               this.b[var2][var16 * 4 + 1] = (byte)var14;
               this.b[var2][var16 * 4 + 2] = (byte)var6;
               this.b[var2][var16 * 4 + 3] = (byte)var15;
            }
         }
      }
   ...
   public void a() {
      ...
      for(int var2 = 0; var2 < 256; ++var2) {
         ...
         this.f[var2 * 4 + 0] = (byte)var3;
         this.f[var2 * 4 + 1] = (byte)var4;
         this.f[var2 * 4 + 2] = (byte)var5;
         this.f[var2 * 4 + 3] = (byte)var6;
      }

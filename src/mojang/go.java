...
public enum go {
   ...
   public final int E;
   // $FF: synthetic field
   private static final go[] F = new go[]{a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w, x, y};


   private go(String var1, int var2, String var3, int var4, int var5, int var6, int var7) {
      this.A = var3;
      this.B = var4;
      this.C = var5;
      this.D = var6;

package mojang.com.jcraft.jogg;
   ...
   public int pageseek(Page var1) {
      ...
      if(this.bodybytes + this.headerbytes > var4) {
         ...
         synchronized(this.chksum) {
            ...
            this.data[var2 + 24] = 0;
            this.data[var2 + 25] = 0;
            Page var11 = this.pageseek;
            var11.header_base = this.data;
            var11.header = var2;
            var11.header_len = this.headerbytes;
            var11.body_base = this.data;
            var11.body = var2 + this.headerbytes;
            var11.body_len = this.bodybytes;
            var11.checksum();

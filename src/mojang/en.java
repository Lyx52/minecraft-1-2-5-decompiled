...
public class en {
   ...
   private transient mh[] a = new mh[16];
   ...
   public Object a(long var1) {
      ...
      for(mh var4 = this.a[a(var3, this.a.length)]; var4 != null; var4 = var4.c) {
         if(var4.a == var1) {
            return var4.b;
         }
      }
   ...
   public void a(long var1, Object var3) {
      ...
      for(mh var6 = this.a[var5]; var6 != null; var6 = var6.c) {
         if(var6.a == var1) {
            var6.b = var3;
         }
      }
   ...
   private void a(int var1, long var2, Object var4, int var5) {
      mh var6 = this.a[var5];
      this.a[var5] = new mh(var1, var2, var4, var6);
      if(this.b++ >= this.c) {

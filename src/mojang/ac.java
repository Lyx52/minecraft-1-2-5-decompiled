...
public class ac extends rt {
   ...
   public ac(World var1, double var2, double var4, double var6, double var8, double var10, double var12) {
      this(var1, var2, var4, var6, var8, var10, var12, 2.0F);
   }

   public ac(World var1, double var2, double var4, double var6, double var8, double var10, double var12, float var14) {
      super(var1, var2, var4, var6, 0.0D, 0.0D, 0.0D);
      this.r *= 0.009999999776482582D;
      this.s *= 0.009999999776482582D;
      this.t *= 0.009999999776482582D;
      this.s += 0.2D;
      this.ao = Utils.sin(((float)var8 + 0.0F) * 3.1415927F * 2.0F) * 0.65F + 0.35F;
      this.ap = Utils.sin(((float)var8 + 0.33333334F) * 3.1415927F * 2.0F) * 0.65F + 0.35F;
      this.aq = Utils.sin(((float)var8 + 0.6666667F) * 3.1415927F * 2.0F) * 0.65F + 0.35F;
      this.am *= 0.75F;
      this.am *= var14;
      this.a = this.am;
      this.e = 6;

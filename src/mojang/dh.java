...
public class dh extends um {
   ...
   public void a(BaseEntity var1, double var2, double var4, double var6, float var8, float var9) {
      ...
      go var10 = ((Painting)var1).e;
      float var11 = 0.0625F;
      GL11.glScalef(var11, var11, var11);
      this.a(((Painting)var1), var10.B, var10.C, var10.D, var10.E);
      GL11.glDisable('\u803a');
      GL11.glPopMatrix();
   }
   ...
   private void a(Painting var1, float var2, float var3) {
      int var4 = Utils.c(var1.o);
      int var5 = Utils.c(var1.p + (double)(var3 / 16.0F));
      int var6 = Utils.c(var1.q);
      if(var1.a == 0) {
         var4 = Utils.c(var1.o + (double)(var2 / 16.0F));
      }

      if(var1.a == 1) {
         var6 = Utils.c(var1.q - (double)(var2 / 16.0F));
      }
      ...
      int var8 = var7 % 65536;
      int var9 = var7 / 65536;
      ARBTextureHelper.setMultiTexCoord2f(ARBTextureHelper.b, (float)var8, (float)var9);

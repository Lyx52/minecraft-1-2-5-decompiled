...
public class Sheep extends bc {
   ...
   public float d(float var1) {
      if(this.b > 4 && this.b <= 36) {
         ...
         return 0.62831855F + 0.21991149F * Utils.sin(var2 * 28.7F);
      } else {
      ...
      if(var2 != null && var2.c == yr.be.bQ && !this.u() && !this.bi()) {
         if(!this.k.F) {
            ...
            for(int var4 = 0; var4 < var3; ++var4) {
               Item var5 = this.a(new aan(pb.ab.bO, 1, this.t()), 1.0F);
   ...
   public void b(CompundTag var1) {
      super.b(var1);
      var1.addBoolean("Sheared", this.u());
      var1.addByte("Color", (byte)this.t());
   }

   public void a(CompundTag var1) {
      super.a(var1);
      this.a(var1.getBoolean("Sheared"));
      this.c_(var1.getByte("Color"));
   }

...
public class mc extends rt {
   ...
   public mc(World var1, double var2, double var4, double var6, double var8, double var10, double var12, pb var14, int var15, int var16) {
   ...
   public mc a(int var1, int var2, int var3) {
      if(this.a == pb.u) {
         ...
         int var4 = this.a.c((WorldInterface)this.k, var1, var2, var3);

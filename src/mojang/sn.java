...
public class sn extends agy {
   ...
   public void a(World var1, int var2, int var3, int var4, Mob var5) {
      ...
      byte var10 = 0;
      int var11 = Utils.c((double)(var5.u * 4.0F / 360.0F) + 0.5D) & 3;
      if(var11 == 0) {
         var10 = 2;
      }
      ...
      if(!var1.F) {
         ...
         if(var5 != this.bO && var6 != this.bO) {
            if(var7 != this.bO && var8 != this.bO) {
               ...
               if((n[var5] || n[var10]) && !n[var6] && !n[var11]) {
                  var13 = 3;
               }

               if((n[var6] || n[var11]) && !n[var5] && !n[var10]) {
                  var13 = 2;
               }
            }
         } else {
            ...
            if((n[var7] || n[var10]) && !n[var8] && !n[var11]) {
               var13 = 5;
            }

            if((n[var8] || n[var11]) && !n[var7] && !n[var10]) {
               var13 = 4;
            }
         }
      ...
      if(var5 == 1) {
         ...
         if(var6 != this.bO && var7 != this.bO) {
            if(var8 != this.bO && var9 != this.bO) {
               ...
               var13 = 3;
               if((n[var6] || n[var11]) && !n[var7] && !n[var12]) {
                  var13 = 3;
               }

               if((n[var7] || n[var12]) && !n[var6] && !n[var11]) {
                  var13 = 2;
               }
            ...
            var13 = 5;
            if((n[var8] || n[var11]) && !n[var9] && !n[var12]) {
               var13 = 5;
            }

            if((n[var9] || n[var12]) && !n[var8] && !n[var11]) {
               var13 = 4;
            }
      ...
      if(var5 != null) {
         for(int var6 = 0; var6 < var5.a(); ++var6) {
            ...
            if(var7 != null) {
               ...
               Item var12;
               for(float var10 = this.a.nextFloat() * 0.8F + 0.1F; var7.a > 0; var1.a((BaseEntity)var12)) {
                  ...
                  var7.a -= var11;
                  var12 = new Item(var1, (double)((float)var2 + var8), (double)((float)var3 + var9), (double)((float)var4 + var10), new aan(var7.c, var11, var7.i()));
                  float var13 = 0.05F;
   ...
   private static boolean j(World var0, int var1, int var2, int var3) {
      Iterator var4 = var0.a(Ozelot.class, wu.b((double)var1, (double)(var2 + 1), (double)var3, (double)(var1 + 1), (double)(var2 + 2), (double)(var3 + 1))).iterator();

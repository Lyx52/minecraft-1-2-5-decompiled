...
public class rp extends li {
   ...
   public boolean a(xd var1, Random var2, int var3, int var4, int var5) {
      if(var1.a(var3, var4 + 1, var5) != pb.t.bO) {
         ...
         return false;
      } else if(var1.a(var3, var4, var5) != 0 && var1.a(var3, var4, var5) != pb.t.bO) {
         return false;
      } else {
         int var6 = 0;
         if(var1.a(var3 - 1, var4, var5) == pb.t.bO) {
            ++var6;
         }
         ...
         if(var1.a(var3, var4, var5 - 1) == pb.t.bO) {
            ++var6;
         }

...
public class Ghast extends akn implements xf {

   public int a = 0;
   public double b;
   public double c;
   public double d;
   private BaseEntity an = null;
   private int ao = 0;
   public int e = 0;
   public int am = 0;
   ...
   public boolean a(md var1, int var2) {
      if("fireball".equals(var1.l()) && var1.a() instanceof Player) {
         super.a(var1, 1000);
         ((Player)var1.a()).a((ajw)dp.y);
         return true;
      } else {
   ...
   public void J_() {
      ...
      this.bm = var1 == 1? "/mojang/mob/ghast_fire.png" : "/mojang/mob/ghast.png";
   }
   ...
   protected void y_() {
      ...
      double var7 = (double) Utils.sqrt(var1 * var1 + var3 * var3 + var5 * var5);
      ...
      if(this.an != null && this.an.f(this) < var9 * var9) {
         ...
         if(this.m(this.an)) {
            if(this.am == 10) {
               this.k.a((Player)null, 1007, (int)this.o, (int)this.p, (int)this.q, 0);
            }

            ++this.am;
            if(this.am == 20) {
               this.k.a((Player)null, 1008, (int)this.o, (int)this.p, (int)this.q, 0);
               Fireball var17 = new Fireball(this.k, this, var11, var13, var15);
               double var18 = 4.0D;
               bo var20 = this.k(1.0F);
               var17.o = this.o + var20.a * var18;
               var17.p = this.p + (double)(this.J / 2.0F) + 0.5D;
               var17.q = this.q + var20.c * var18;
               this.k.a((BaseEntity)var17);
               this.am = -40;
            }
         } else if(this.am > 0) {
            --this.am;
   ...
   private boolean a(double var1, double var3, double var5, double var7) {
      ...
      for(int var16 = 1; (double)var16 < var7; ++var16) {
         ...
         if(this.k.a((BaseEntity)this, var15).size() > 0) {
            return false;
         }
      }
   ...
   protected String m() {
      return "mojang.mob.ghast.moan";
   }

   protected String n() {
      return "mojang.mob.ghast.scream";
   }

   protected String o() {
      return "mojang.mob.ghast.death";
   }

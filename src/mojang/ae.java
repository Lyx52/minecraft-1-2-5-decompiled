...
public class ae extends pb {
   ...
   public void b(World var1, int var2, int var3, int var4) {
      if(!var1.F) {
         PrimeTnt var5 = new PrimeTnt(var1, (double)((float)var2 + 0.5F), (double)((float)var3 + 0.5F), (double)((float)var4 + 0.5F));
         var5.a = var1.r.nextInt(var5.a / 4) + var5.a / 8;
         var1.a((BaseEntity)var5);
      }
   }
   ...
   public void b(World var1, int var2, int var3, int var4, int var5) {
      if(!var1.F) {
         if((var5 & 1) == 0) {
            ...
            PrimeTnt var6 = new PrimeTnt(var1, (double)((float)var2 + 0.5F), (double)((float)var3 + 0.5F), (double)((float)var4 + 0.5F));

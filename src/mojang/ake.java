...
public class ake extends ho {
   ...
   public void a(float var1, float var2, float var3, float var4, float var5, float var6) {
      ...
      for(var8 = 0; var8 < 4; ++var8) {
         this.a[var8].d = -2.0F + gk.b(((float)(var8 * 2) + var3) * 0.25F);
         this.a[var8].c = gk.b(var7) * 9.0F;
         this.a[var8].e = gk.a(var7) * 9.0F;
         ++var7;
      }
      ...
      for(var8 = 4; var8 < 8; ++var8) {
         this.a[var8].d = 2.0F + gk.b(((float)(var8 * 2) + var3) * 0.25F);
         this.a[var8].c = gk.b(var7) * 7.0F;
         this.a[var8].e = gk.a(var7) * 7.0F;
         ++var7;
      }
      ...
      for(var8 = 8; var8 < 12; ++var8) {
         this.a[var8].d = 11.0F + gk.b(((float)var8 * 1.5F + var3) * 0.5F);
         this.a[var8].c = gk.b(var7) * 5.0F;
         this.a[var8].e = gk.a(var7) * 5.0F;
         ++var7;
      }

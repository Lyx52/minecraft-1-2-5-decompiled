...
public class Villager extends ajr {
   ...
   public Villager(World var1) {
      this(var1, 0);
   }

   public Villager(World var1, int var2) {
      super(var1);
      this.b = 0;
      this.c = false;
      this.d = false;
      ...
      this.bT.a(1, new fg(this, Zombie.class, 8.0F, 0.3F, 0.35F));
      ...
      this.bT.a(9, new vi(this, Player.class, 3.0F, 1.0F));
      this.bT.a(9, new vi(this, Villager.class, 5.0F, 0.02F));
      this.bT.a(9, new acu(this, 0.3F));
      this.bT.a(10, new ob(this, Mob.class, 8.0F));
   }
   ...
   protected void g() {
      if(--this.b <= 0) {
         this.k.A.a(Utils.c(this.o), Utils.c(this.p), Utils.c(this.q));
   ...
   public void b(CompundTag var1) {
      super.b(var1);
      var1.addInt("Profession", this.u());
   }

   public void a(CompundTag var1) {
      super.a(var1);
      this.d_(var1.getInt("Profession"));
   }

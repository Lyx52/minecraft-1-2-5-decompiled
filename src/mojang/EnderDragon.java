...
public class EnderDragon extends ajn {
   ...
   public EnderDragon(World var1) {
      ...
      this.aA = 200;
      this.l(this.aA);
      this.bm = "/mojang/mob/enderdragon/ender.png";
      this.a(16.0F, 8.0F);
      this.S = true;
      this.ab = true;
      this.b = 100.0D;
   ...
   public void e() {
      ...
      if(this.bx <= 0) {
         ...
         this.af();
         var1 = 0.2F / (Utils.sqrt(this.r * this.r + this.t * this.t) * 10.0F + 1.0F);
         ...
         if(this.k.F) {
            ...
            var4 /= (double) Utils.sqrt(var25 * var25 + var6 * var6);
            var31 = 0.6F;
            ...
            bo var15 = mojang.bo.b(this.a - this.o, this.b - this.p, this.c - this.q).c();
            bo var39 = mojang.bo.b((double) Utils.sin(this.u * 3.1415927F / 180.0F), this.s, (double)(-Utils.cos(this.u * 3.1415927F / 180.0F))).c();
            ...
            this.cg *= 0.8F;
            float var18 = Utils.sqrt(this.r * this.r + this.t * this.t) * 1.0F + 1.0F;
            ...
            bo var23 = mojang.bo.b(this.r, this.s, this.t).c();
         ...
         var3 = Utils.cos(var26);
         float var27 = -Utils.sin(var26);
         float var5 = this.u * 3.1415927F / 180.0F;
         float var28 = Utils.sin(var5);
         float var7 = Utils.cos(var5);
         this.ao.J_();
         ...
         if(!this.k.F && this.bB == 0) {
            this.a(this.k.b((BaseEntity)this, this.as.y.b(4.0D, 2.0D, 4.0D).d(0.0D, -2.0D, 0.0D)));
            this.a(this.k.b((BaseEntity)this, this.at.y.b(4.0D, 2.0D, 4.0D).d(0.0D, -2.0D, 0.0D)));
            this.b(this.k.b((BaseEntity)this, this.an.y.b(1.0D, 1.0D, 1.0D)));
         }

         double[] var29 = this.a(5, 1.0F);
         double[] var9 = this.a(0, 1.0F);
         var31 = Utils.sin(this.u * 3.1415927F / 180.0F - this.cg * 0.01F);
         float var33 = Utils.cos(this.u * 3.1415927F / 180.0F - this.cg * 0.01F);
         this.an.J_();
         ...
         for(int var30 = 0; var30 < 3; ++var30) {
            ...
            float var37 = Utils.sin(var35);
            float var36 = Utils.cos(var35);
            float var38 = 1.5F;
   ...
   private void af() {
      ...
      if(this.U.nextInt(10) == 0) {
         float var1 = 32.0F;
         List var2 = this.k.a(EnderCrystal.class, this.y.b((double)var1, (double)var1, (double)var1));
         EnderCrystal var3 = null;
         double var4 = Double.MAX_VALUE;
         Iterator var6 = var2.iterator();

         while(var6.hasNext()) {
            BaseEntity var7 = (BaseEntity)var6.next();
            double var8 = var7.f(this);
            if(var8 < var4) {
               var4 = var8;
               var3 = (EnderCrystal)var7;
            }
         }
   ...
   private void b(List var1) {
      for(int var2 = 0; var2 < var1.size(); ++var2) {
         BaseEntity var3 = (BaseEntity)var1.get(var2);
         if(var3 instanceof Mob) {
            var3.a(md.a((Mob)this), 10);
         }
      }
   ...
   private void ah() {
      ...
      if(this.U.nextInt(2) == 0 && this.k.d.size() > 0) {
         this.aB = (BaseEntity)this.k.d.get(this.U.nextInt(this.k.d.size()));
      } else {
         boolean var1 = false;
   ...
   private boolean a(wu var1) {
      ...
      int var3 = Utils.c(var1.b);
      int var4 = Utils.c(var1.c);
      int var5 = Utils.c(var1.d);
      int var6 = Utils.c(var1.e);
      int var7 = Utils.c(var1.f);
      boolean var8 = false;
      boolean var9 = false;
   ...
   public boolean a(dg var1, md var2, int var3) {
      ...
      float var5 = Utils.sin(var4);
      float var6 = Utils.cos(var4);
      ...
      this.aB = null;
      if(var2.a() instanceof Player || var2 == md.l) {
         this.e(var2, var3);
      }
   ...
   protected void w_() {
      ...
      if(!this.k.F && this.ay > 150 && this.ay % 5 == 0) {
         ...
         while(var4 > 0) {
            var5 = XPOrb.b(var4);
            var4 -= var5;
            this.k.a((BaseEntity)(new XPOrb(this.k, this.o, this.p, this.q, var5)));
         }
      }
      ...
      if(this.ay == 200) {
         ...
         this.a(Utils.c(this.o), Utils.c(this.q));
         this.bc();
         this.A();
      }
      ...
      for(int var5 = var3 - 1; var5 <= var3 + 32; ++var5) {
         for(int var6 = var1 - var4; var6 <= var1 + var4; ++var6) {
            for(int var7 = var2 - var4; var7 <= var2 + var4; ++var7) {
               ...
               double var12 = (double) Utils.sqrt(var8 * var8 + var10 * var10);

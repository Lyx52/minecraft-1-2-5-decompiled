...
public class VillagerGolem extends akm {
   ...
   public VillagerGolem(World var1) {
      super(var1);
      this.bm = "/mojang/mob/villager_golem.png";
      this.a(1.4F, 2.9F);
      this.aM().a(true);
      ...
      this.bT.a(7, new ob(this, Player.class, 6.0F));
      this.bT.a(8, new bd(this));
      this.bU.a(1, new hd(this));
      this.bU.a(2, new zy(this, false));
      this.bU.a(3, new amf(this, Monster.class, 16.0F, 0, false, true));
   }
   ...
   protected void g() {
      if(--this.b <= 0) {
         ...
         this.a = this.k.A.a(Utils.c(this.o), Utils.c(this.p), Utils.c(this.q), 32);
         if(this.a == null) {
            this.aX();
         } else {
            uh var1 = this.a.a();
   ...
   public boolean a(Class var1) {
      return this.F_() && Player.class.isAssignableFrom(var1)?false:super.a(var1);
   }

   public void b(CompundTag var1) {
      super.b(var1);
      var1.addBoolean("PlayerCreated", this.F_());
   }

   public void a(CompundTag var1) {
      super.a(var1);
      this.b(var1.getBoolean("PlayerCreated"));
   }

   public boolean c(BaseEntity var1) {
      this.c = 10;
      this.k.a(this, (byte)4);
      boolean var2 = var1.a(md.a((Mob)this), 7 + this.U.nextInt(15));
      if(var2) {
         var1.s += 0.4000000059604645D;
      }

      this.k.a(this, "mojang.mob.irongolem.throw", 1.0F, 1.0F);
      return var2;
   }
   ...
   protected String n() {
      return "mojang.mob.irongolem.hit";
   }

   protected String o() {
      return "mojang.mob.irongolem.death";
   }

   protected void a(int var1, int var2, int var3, int var4) {
      this.k.a(this, "mojang.mob.irongolem.walk", 1.0F, 1.0F);
   }

...
public class adn {
   ...
   private void e() {
      ...
      try {
         BufferedReader var2 = new BufferedReader(new InputStreamReader(adn.class.getResourceAsStream("/lang/languages.txt"), "UTF-8"));
   ...
   private void a(Properties var1, String var2) {
      BufferedReader var3 = new BufferedReader(new InputStreamReader(adn.class.getResourceAsStream("/lang/" + var2 + ".lang"), "UTF-8"));

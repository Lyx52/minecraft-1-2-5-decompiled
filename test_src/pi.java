...
public class pi extends aas {

   public pi(int var1, Random var2, qg var3, int var4) {
      super(var1);
      this.h = var4;
      this.g = var3;
   }
   ...
   public static pi a(List var0, Random var1, int var2, int var3, int var4, int var5, int var6) {
      qg var7 = qg.a(var2, var3, var4, -5, -3, 0, 13, 14, 13, var5);
      return a(var7) && he.a(var0, var7) == null?new pi(var6, var1, var7, var5):null;
   }
   ...
   public boolean a(xd var1, Random var2, qg var3) {
      ...
      this.a(var1, var3, 5, 8, 0, 7, 8, 0, pb.bB.bO, pb.bB.bO, false);
      ...
      for(var4 = 4; var4 <= 8; ++var4) {
         for(var5 = 0; var5 <= 2; ++var5) {
            ...
            this.b(var1, pb.bA.bO, 0, var4, -1, 12 - var5, var3);
         }
      }
      ...
      for(var4 = 0; var4 <= 2; ++var4) {
         for(var5 = 4; var5 <= 8; ++var5) {
            this.b(var1, pb.bA.bO, 0, var4, -1, var5, var3);
            this.b(var1, pb.bA.bO, 0, 12 - var4, -1, var5, var3);
         }
      }

      this.a(var1, var3, 5, 5, 5, 7, 5, 7, pb.bA.bO, pb.bA.bO, false);
      this.a(var1, var3, 6, 1, 6, 6, 4, 6, 0, 0, false);
      this.a(var1, pb.bA.bO, 0, 6, 0, 6, var3);
      this.a(var1, pb.C.bO, 0, 6, 5, 6, var3);
      var4 = this.a(6, 6);
      var5 = this.b(5);
      int var6 = this.b(6, 6);
      if(var3.b(var4, var5, var6)) {
         var1.a = true;
         pb.m[pb.C.bO].a(var1, var4, var5, var6, var2);
         var1.a = false;
      }

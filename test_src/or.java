...
public class or extends fe {
   ...
   protected void a(oq var1, float var2, float var3, float var4) {
   ...
   protected void a(oq var1, float var2, float var3, float var4, float var5, float var6, float var7) {
      if(var1.ay > 0) {
         float var8 = (float)var1.ay / 200.0F;
         GL11.glDepthFunc(515);
         GL11.glEnable(3008);
         GL11.glAlphaFunc(516, var8);
         this.a(var1.Z, "/mob/enderdragon/shuffle.png");
   ...
   public void a(oq var1, double var2, double var4, double var6, float var8, float var9) {
      c = var1;
      if(i != 4) {
         this.a = new aks(0.0F);
         i = 4;
      ...
      if(var1.az != null) {
         ...
         float var12 = (float)(var1.az.o - var1.o - (var1.l - var1.o) * (double)(1.0F - var9));
         float var13 = (float)((double)var11 + var1.az.p - 1.0D - var1.p - (var1.m - var1.p) * (double)(1.0F - var9));
         float var14 = (float)(var1.az.q - var1.q - (var1.n - var1.q) * (double)(1.0F - var9));
         float var15 = gk.c(var12 * var12 + var14 * var14);
         float var16 = gk.c(var12 * var12 + var13 * var13 + var14 * var14);
         GL11.glPushMatrix();
         ...
         float var19 = gk.c(var12 * var12 + var13 * var13 + var14 * var14) / 32.0F - ((float)var1.V + var9) * 0.01F;
         var17.a(5);
         byte var20 = 8;

         for(int var21 = 0; var21 <= var20; ++var21) {
            float var22 = gk.a((float)(var21 % var20) * 3.1415927F * 2.0F / (float)var20) * 0.75F;
            float var23 = gk.b((float)(var21 % var20) * 3.1415927F * 2.0F / (float)var20) * 0.75F;
   ...
   protected void a(oq var1, float var2) {
      super.b(var1, var2);
      adz var3 = adz.a;
      if(var1.ay > 0) {
         tf.a();
   ...
   protected int a(oq var1, int var2, float var3) {
      if(var2 == 1) {
         GL11.glDepthFunc(515);
      }

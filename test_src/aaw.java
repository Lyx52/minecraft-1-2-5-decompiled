...
public class aaw {
   ...
   private IntBuffer g = ew.d(1);
   private ByteBuffer h = ew.c(16777216);
   ...
   public int[] a(String var1) {
      ...
      if(var3 != null) {
         ...
         try {
            Object var6 = null;
            if(var1.startsWith("##")) {
               var3 = this.b(this.c(this.a(var2.a(var1.substring(2)))));
            } else if(var1.startsWith("%clamp%")) {
               this.b = true;
               var3 = this.b(this.a(var2.a(var1.substring(7))));
               this.b = false;
            } else if(var1.startsWith("%blur%")) {
               this.c = true;
               this.b = true;
               var3 = this.b(this.a(var2.a(var1.substring(6))));
               this.b = false;
               this.c = false;
            } else {
               InputStream var7 = var2.a(var1);
               if(var7 == null) {
                  var3 = this.b(this.m);
               } else {
                  var3 = this.b(this.a(var7));
               }
            }
   ...
   public int b(String var1) {
      ...
      if(var3 != null) {
         ...
         try {
            ...
            if(var1.startsWith("##")) {
               this.a(this.c(this.a(var2.a(var1.substring(2)))), var6);
            } else if(var1.startsWith("%clamp%")) {
               this.b = true;
               this.a(this.a(var2.a(var1.substring(7))), var6);
               this.b = false;
            } else if(var1.startsWith("%blur%")) {
               this.c = true;
               this.a(this.a(var2.a(var1.substring(6))), var6);
               this.c = false;
            } else if(var1.startsWith("%blurclamp%")) {
               this.c = true;
               this.b = true;
               this.a(this.a(var2.a(var1.substring(11))), var6);
               this.c = false;
               this.b = false;
            } else {
               InputStream var7 = var2.a(var1);
               if(var7 == null) {
                  ...
                  this.a(this.a(var7), var6);
               }
            }

            this.d.put(var1, Integer.valueOf(var6));
            return var6;
            ...
            this.a(this.m, var4);
            this.d.put(var1, Integer.valueOf(var4));
            return var4;
         }
      }
   }
   ...
   public int a(String var1, String var2) {
      ...
      return var3 != null && var3.c >= 0?var3.c:(var2 == null?-1:this.b(var2));
   }
   ...
   public void b() {
      ...
      while(var2.hasNext()) {
         ...
         try {
            if(var9.startsWith("##")) {
               var4 = this.c(this.a(var1.a(var9.substring(2))));
            } else if(var9.startsWith("%clamp%")) {
               this.b = true;
               var4 = this.a(var1.a(var9.substring(7)));
            } else if(var9.startsWith("%blur%")) {
               this.c = true;
               var4 = this.a(var1.a(var9.substring(6)));
            } else if(var9.startsWith("%blurclamp%")) {
               this.c = true;
               this.b = true;
               var4 = this.a(var1.a(var9.substring(11)));
            } else {
               var4 = this.a(var1.a(var9));
            }

            int var5 = ((Integer)this.d.get(var9)).intValue();
            this.a(var4, var5);
            this.c = false;
            this.b = false;
   ...
   private BufferedImage a(InputStream var1) {

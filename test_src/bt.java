...
public class bt extends nn {
   ...
   public bt(xd var1, double var2, double var4, double var6, double var8, double var10, double var12) {
      super(var1);
      this.a(1.0F, 1.0F);
      this.c(var2, var4, var6, this.u, this.v);
      this.d(var2, var4, var6);
      double var14 = (double)gk.a(var8 * var8 + var10 * var10 + var12 * var12);
      this.b = var8 / var14 * 0.1D;
      this.c = var10 / var14 * 0.1D;
      this.d = var12 / var14 * 0.1D;
   }

   public bt(xd var1, acq var2, double var3, double var5, double var7) {
      super(var1);
      this.a = var2;
      this.a(1.0F, 1.0F);
   ...
   public void J_() {
      if(!this.k.F && (this.a != null && this.a.G || !this.k.j((int)this.o, (int)this.p, (int)this.q))) {
         ...
         for(int var8 = 0; var8 < var5.size(); ++var8) {
            ...
            if(var9.l_() && (!var9.a((nn)this.a) || this.ar >= 25)) {
               float var10 = 0.3F;
   ...
   protected void a(pl var1) {
      if(!this.k.F) {
         ...
         this.k.a((nn)null, this.o, this.p, this.q, 1.0F, true);
         this.A();
      }
   ...
   public void b(ady var1) {
      ...
      var1.a("inGround", (byte)(this.ap?1:0));
   }

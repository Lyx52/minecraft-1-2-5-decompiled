...
public class ul extends pb {
   ...
   public boolean e(xd var1, int var2, int var3, int var4) {
      return var1.h(var2, var3 - 1, var4) || var1.a(var2, var3 - 1, var4) == pb.aZ.bO;
   }
   ...
   public void a(xd var1, int var2, int var3, int var4, int var5) {
      boolean var6 = false;
      if(!var1.h(var2, var3 - 1, var4) && var1.a(var2, var3 - 1, var4) != pb.aZ.bO) {
         var6 = true;
      }
   ...
   private void h(xd var1, int var2, int var3, int var4) {
      ...
      List var8 = null;
      if(this.a == agw.a) {
         var8 = var1.b((nn)null, wu.b((double)((float)var2 + var7), (double)var3, (double)((float)var4 + var7), (double)((float)(var2 + 1) - var7), (double)var3 + 0.25D, (double)((float)(var4 + 1) - var7)));
      }

      if(this.a == agw.b) {
         var8 = var1.a(acq.class, wu.b((double)((float)var2 + var7), (double)var3, (double)((float)var4 + var7), (double)((float)(var2 + 1) - var7), (double)var3 + 0.25D, (double)((float)(var4 + 1) - var7)));
      }

      if(this.a == agw.c) {
         var8 = var1.a(yw.class, wu.b((double)((float)var2 + var7), (double)var3, (double)((float)var4 + var7), (double)((float)(var2 + 1) - var7), (double)var3 + 0.25D, (double)((float)(var4 + 1) - var7)));
      }

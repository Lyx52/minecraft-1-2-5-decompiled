...
public class bj extends av {
   ...
   public bj(xd var1, acq var2, int var3) {
      super(var1, var2);
      this.d = var3;
   }

   public bj(xd var1, double var2, double var4, double var6, int var8) {
   ...
   protected void a(pl var1) {
      if(!this.k.F) {
         ...
         if(var2 != null && !var2.isEmpty()) {
            ...
            List var4 = this.k.a(acq.class, var3);
               ...
               while(var5.hasNext()) {
                  ...
                  if(var7 < 16.0D) {
                     ...
                     while(var11.hasNext()) {
                        ...
                        int var13 = var12.a();
                        if(aad.a[var13].b()) {
                           aad.a[var13].a(this.c, (acq)var6, var12.c(), var9);
                        } else {
                           int var14 = (int)(var9 * (double)var12.b() + 0.5D);
                           if(var14 > 20) {
                              ((acq)var6).b(new alg(var13, var14, var12.c()));
                           }
                        }
                     }
                  }

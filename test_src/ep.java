...
public class ep extends nn {
   ...
   public ep(xd var1, double var2, double var4, double var6) {
      this(var1);
   ...
   public void J_() {
      ...
      if(this.k.F) {
         ...
         this.b(this.u, this.v);
         List var16 = this.k.b((nn)this, this.y.b(0.20000000298023224D, 0.0D, 0.20000000298023224D));
         int var24;
         if(var16 != null && var16.size() > 0) {
            for(var24 = 0; var24 < var16.size(); ++var24) {
               nn var18 = (nn)var16.get(var24);
               if(var18 != this.i && var18.d_() && var18 instanceof ep) {
                  var18.g(this);
               }
            }
         }
         ...
         for(var24 = 0; var24 < 4; ++var24) {
            int var25 = gk.c(this.o + ((double)(var24 % 2) - 0.5D) * 0.8D);
            int var19 = gk.c(this.p);
            int var20 = gk.c(this.q + ((double)(var24 / 2) - 0.5D) * 0.8D);

...
public abstract class nn {
   ...
   public boolean equals(Object var1) {
      return var1 instanceof nn?((nn)var1).f == this.f:false;
   }
   ...
   public void d(double var1, double var3, double var5) {
      ...
      float var8 = this.J;
      this.y.c(var1 - (double)var7, var3 - (double)this.H + (double)this.Q, var5 - (double)var7, var1 + (double)var7, var3 - (double)this.H + (double)this.Q + (double)var8, var5 + (double)var7);
   }
   ...
   public void B() {
      ...
      if(this.g_()) {
         if(!this.X && !this.d) {
            float var6 = gk.a(this.r * this.r * 0.20000000298023224D + this.s * this.s + this.t * this.t * 0.20000000298023224D) * 0.2F;
            if(var6 > 1.0F) {
               var6 = 1.0F;
            }

            this.k.a(this, "random.splash", var6, 1.0F + (this.U.nextFloat() - this.U.nextFloat()) * 0.4F);
            float var7 = (float)gk.c(this.y.b);
   ...
   public void b(double var1, double var3, double var5) {
      if(this.S) {
         ...
         double var15 = var5;
         wu var17 = this.y.d();
         boolean var18 = this.z && this.V() && this instanceof yw;
         if(var18) {
            double var19;
         ...
         if(this.e_() && !var18 && this.j == null) {
            this.L = (float)((double)this.L + (double)gk.a(var37 * var37 + var23 * var23) * 0.6D);
            var38 = gk.c(this.o);
            var26 = gk.c(this.p - 0.20000000298023224D - (double)this.H);
            var39 = gk.c(this.q);
         ...
         var38 = gk.c(this.y.a + 0.001D);
         var26 = gk.c(this.y.b + 0.001D);
         var39 = gk.c(this.y.c + 0.001D);
         var28 = gk.c(this.y.d - 0.001D);
         int var29 = gk.c(this.y.e - 0.001D);
         int var30 = gk.c(this.y.f - 0.001D);
      ...
      if(var3) {
         if(this.M > 0.0F) {
            if(this instanceof acq) {
               int var4 = gk.c(this.o);
               int var5 = gk.c(this.p - 0.20000000298023224D - (double)this.H);
               int var6 = gk.c(this.q);
               ...
               if(var7 > 0) {
                  pb.m[var7].a(this.k, var4, var5, var6, this, this.M);
               }
            }
         ...
         this.M = (float)((double)this.M - var1);
      }
   ...
   public boolean G() {
      return this.X || this.k.y(gk.c(this.o), gk.c(this.p), gk.c(this.q));
   }
   ...
   public void a(float var1, float var2, float var3) {
      float var4 = gk.c(var1 * var1 + var2 * var2);
      if(var4 >= 0.01F) {
         if(var4 < 1.0F) {
            var4 = 1.0F;
         }
         ...
         var1 *= var4;
         var2 *= var4;
         float var5 = gk.a(this.u * 3.1415927F / 180.0F);
         float var6 = gk.b(this.u * 3.1415927F / 180.0F);
   ...
   public void c(double var1, double var3, double var5, float var7, float var8) {
      this.N = this.l = this.o = var1;
      this.O = this.m = this.p = var3 + (double)this.H;
      this.P = this.n = this.q = var5;
      this.u = var7;
      this.v = var8;
      this.d(this.o, this.p, this.q);
   }

   public float e(nn var1) {
   ...
   public double g(double var1, double var3, double var5) {
      ...
      double var9 = this.p - var3;
      double var11 = this.q - var5;
      return (double)gk.a(var7 * var7 + var9 * var9 + var11 * var11);
   }

   public double f(nn var1) {
   ...
   public void g(nn var1) {
      if(var1.i != this && var1.j != this) {
         ...
         double var6 = gk.a(var2, var4);
         if(var6 >= 0.009999999776482582D) {
            var6 = (double)gk.a(var6);
            var2 /= var6;
            var4 /= var6;
   ...
   public void d(ady var1) {
      var1.a("Pos", (gh)this.a(new double[]{this.o, this.p + (double)this.Q, this.q}));
      var1.a("Motion", (gh)this.a(new double[]{this.r, this.s, this.t}));
      var1.a("Rotation", (gh)this.a(new float[]{this.u, this.v}));
      var1.a("FallDistance", this.M);
      var1.a("Fire", (short)this.c);
      var1.a("Air", (short)this.Y());
      var1.a("OnGround", this.z);
      this.b(var1);
   }

   public void e(ady var1) {
      no var2 = var1.n("Pos");
      no var3 = var1.n("Motion");
      no var4 = var1.n("Rotation");
      this.r = ((ahl)var3.a(0)).a;
      this.s = ((ahl)var3.a(1)).a;
      this.t = ((ahl)var3.a(2)).a;
      ...
      this.l = this.N = this.o = ((ahl)var2.a(0)).a;
      this.m = this.O = this.p = ((ahl)var2.a(1)).a;
      this.n = this.P = this.q = ((ahl)var2.a(2)).a;
      this.w = this.u = ((m)var4.a(0)).a;
      this.x = this.v = ((m)var4.a(1)).a;
      this.M = var1.h("FallDistance");
      this.c = var1.e("Fire");
      this.g(var1.e("Air"));
      this.z = var1.o("OnGround");
      this.d(this.o, this.p, this.q);
   ...
   protected abstract void a(ady var1);

   protected abstract void b(ady var1);

   protected no a(double ... var1) {
      no var2 = new no();
      double[] var3 = var1;
      ...
      for(int var5 = 0; var5 < var4; ++var5) {
         ...
         var2.a((gh)(new ahl((String)null, var6)));
      }

      return var2;
   }

   protected no a(float ... var1) {
      no var2 = new no();
      float[] var3 = var1;
      int var4 = var1.length;
      ...
      for(int var5 = 0; var5 < var4; ++var5) {
         ...
         var2.a((gh)(new m((String)null, var6)));
      }
   ...
   public fq b(int var1, int var2) {
      return this.a(var1, var2, 0.0F);
   }

   public fq a(int var1, int var2, float var3) {
      return this.a(new aan(var1, var2, 0), var3);
   }

   public fq a(aan var1, float var2) {
      fq var3 = new fq(this.k, this.o, this.p + (double)var2, this.q, var1);
      var3.c = 10;
      this.k.a((nn)var3);
      return var3;
   }
   ...
   public boolean N() {
      for(int var1 = 0; var1 < 8; ++var1) {
         ...
         int var5 = gk.c(this.o + (double)var2);
         int var6 = gk.c(this.p + (double)this.I() + (double)var3);
         int var7 = gk.c(this.q + (double)var4);

...
public class tw extends um {
   ...
   public void a(fq var1, double var2, double var4, double var6, float var8, float var9) {
      this.d.setSeed(187L);
      aan var10 = var1.a;
      GL11.glPushMatrix();
      float var11 = gk.a(((float)var1.b + var9) / 10.0F + var1.d) * 0.1F + 0.1F;
   ...
   public void a(nl var1, aaw var2, aan var3, int var4, int var5) {
      if(var3 != null) {
         ...
         if(var3 != null && var3.r()) {
            ...
            var2.b(var2.b("%blur%/misc/glint.png"));
            this.b -= 50.0F;
            GL11.glEnable(3042);

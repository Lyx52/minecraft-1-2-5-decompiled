...
public class qx extends w {
   ...
   public void a(xd var1, int var2, int var3, int var4, Random var5) {
      ...
      if(this.c && !var7) {
         var1.d(var2, var3, var4, pb.bh.bO, var6);
      } else if(!this.c) {
         var1.d(var2, var3, var4, pb.bi.bO, var6);
         if(!var7) {
            int var8 = (var6 & 12) >> 2;
            var1.a(var2, var3, var4, pb.bi.bO, b[var8] * 2);
         }
      }
   ...
   private boolean f(xd var1, int var2, int var3, int var4, int var5) {
      ...
      switch(var6) {
      case 0:
         return var1.l(var2, var3, var4 + 1, 3) || var1.a(var2, var3, var4 + 1) == pb.av.bO && var1.e(var2, var3, var4 + 1) > 0;
      case 1:
         return var1.l(var2 - 1, var3, var4, 4) || var1.a(var2 - 1, var3, var4) == pb.av.bO && var1.e(var2 - 1, var3, var4) > 0;
      case 2:
         return var1.l(var2, var3, var4 - 1, 2) || var1.a(var2, var3, var4 - 1) == pb.av.bO && var1.e(var2, var3, var4 - 1) > 0;
      case 3:
         return var1.l(var2 + 1, var3, var4, 5) || var1.a(var2 + 1, var3, var4) == pb.av.bO && var1.e(var2 + 1, var3, var4) > 0;
      default:
         return false;
      }
   }

...
public class abc extends pb {
   ...
   public void b(xd var1, int var2, int var3, int var4, int var5, int var6) {
      ...
      if(var5 == 0) {
         ...
         var1.b(var2, var3, var4, pb.ac.bO, var6);
         ...
         if(this.a) {
            ...
            if(!var14 && var12 > 0 && a(var12, var1, var9, var10, var11, false) && (pb.m[var12].f() == 0 || var12 == pb.Z.bO || var12 == pb.V.bO)) {
               var2 += qs.b[var6];
               var3 += qs.c[var6];
               var4 += qs.d[var6];
               var1.b(var2, var3, var4, pb.ac.bO, var13);
   ...
   private static boolean a(int var0, xd var1, int var2, int var3, int var4, boolean var5) {
      if(var0 == pb.ap.bO) {
         ...
         return !(pb.m[var0] instanceof agy);
      }
   }
      ...
      while(true) {
         ...
         if(var9 < 13) {
            ...
            if(var10 != 0) {
               ...
               pb.m[var10].a(var1, var6, var7, var8, var1.e(var6, var7, var8), 0);
         ...
         while(var6 != var2 || var7 != var3 || var8 != var4) {
            ...
            if(var12 == this.bO && var9 == var2 && var10 == var3 && var11 == var4) {
               var1.b(var6, var7, var8, pb.ac.bO, var5 | (this.a?8:0));
               var1.a(var6, var7, var8, pa.a(pb.aa.bO, var5 | (this.a?8:0), var5, true, false));
            } else {
               var1.b(var6, var7, var8, pb.ac.bO, var13);

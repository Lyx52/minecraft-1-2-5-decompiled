...
public class yo extends wd {
   ...
   public String v_() {
      return this.G_()?"/mob/wolf_tame.png":(this.am()?"/mob/wolf_angry.png":super.v_());
   }
   ...
   protected String m() {
      return this.am()?"mob.wolf.growl":(this.U.nextInt(3) == 0?(this.G_() && this.ac.c(18) < 10?"mob.wolf.whine":"mob.wolf.panting"):"mob.wolf.bark");
   }
   ...
   public void J_() {
      ...
      if(this.G()) {
         ...
         if(this.an == 0.0F) {
            this.k.a(this, "mob.wolf.shake", this.C_(), (this.U.nextFloat() - this.U.nextFloat()) * 0.2F + 1.0F);
         }

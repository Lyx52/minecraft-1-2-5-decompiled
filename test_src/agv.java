...
public abstract class agv extends pb {
   ...
   public static double a(ali var0, int var1, int var2, int var3, acn var4) {
      bo var5 = null;
      if(var4 == acn.g) {
         var5 = ((agv)pb.A).h(var0, var1, var2, var3);
      }

      if(var4 == acn.h) {
         var5 = ((agv)pb.C).h(var0, var1, var2, var3);
      }
      ...
      if(var1.a(var2, var3, var4) == this.bO) {
         if(this.cd == acn.h) {
            ...
            if(var5) {
               ...
               if(var6 == 0) {
                  var1.g(var2, var3, var4, pb.ap.bO);
               } else if(var6 <= 4) {
                  var1.g(var2, var3, var4, pb.w.bO);
               }

...
public class q extends akm {

   public q(xd var1) {
      super(var1);
      this.bm = "/mob/snowman.png";
      this.a(0.4F, 1.8F);
      this.aM().a(true);
      this.bT.a(1, new sf(this, 0.25F, 2, 20));
      this.bT.a(2, new acu(this, 0.2F));
      this.bT.a(3, new ob(this, yw.class, 6.0F));
      this.bT.a(4, new bd(this));
      this.bU.a(1, new amf(this, yy.class, 16.0F, 0, true));
   }
   ...
   public void e() {
      ...
      int var2 = gk.c(this.q);
      if(this.k.a(var1, var2).j() > 1.0F) {
         this.a(md.c, 1);
      }

      for(var1 = 0; var1 < 4; ++var1) {
         var2 = gk.c(this.o + (double)((float)(var1 % 2 * 2 - 1) * 0.25F));
         int var3 = gk.c(this.p);
         int var4 = gk.c(this.q + (double)((float)(var1 / 2 % 2 * 2 - 1) * 0.25F));

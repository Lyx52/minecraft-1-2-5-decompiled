...
public class adx extends aas {

   public adx(int var1, Random var2, qg var3, int var4) {
      super(var1);
      this.h = var4;
      this.g = var3;
   }
   ...
   public static adx a(List var0, Random var1, int var2, int var3, int var4, int var5, int var6) {
      qg var7 = qg.a(var2, var3, var4, -1, 0, 0, 5, 7, 5, var5);
      return a(var7) && he.a(var0, var7) == null?new adx(var6, var1, var7, var5):null;
   }

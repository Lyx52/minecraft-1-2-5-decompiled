...
public abstract class yw extends acq {
   ...
   protected void a(aan var1, int var2) {
      ...
      if(var1.m() == aaq.b) {
         for(int var3 = 0; var3 < var2; ++var3) {
            bo var4 = bo.b(((double)this.U.nextFloat() - 0.5D) * 0.1D, Math.random() * 0.1D + 0.1D, 0.0D);
            var4.a(-this.v * 3.1415927F / 180.0F);
            var4.b(-this.u * 3.1415927F / 180.0F);
            bo var5 = bo.b(((double)this.U.nextFloat() - 0.5D) * 0.3D, (double)(-this.U.nextFloat()) * 0.6D - 0.3D, 0.6D);
   ...
   public void S() {
      this.aC = "http://s3.amazonaws.com/MinecraftCloaks/" + this.aA + ".png";
      this.aa = this.aC;
   }
   ...
   public void e() {
      ...
      if(this.bb() > 0) {
         List var3 = this.k.b((nn)this, this.y.b(1.0D, 0.0D, 1.0D));
         if(var3 != null) {
   ...
   public void a(md var1) {
      ...
      this.ap.i();
      if(var1 != null) {
         this.r = (double)(-gk.b((this.bC + this.u) * 3.1415927F / 180.0F) * 0.1F);
         this.t = (double)(-gk.a((this.bC + this.u) * 3.1415927F / 180.0F) * 0.1F);
      } else {
         this.r = this.t = 0.0D;
      }
   ...
   public fq a(aan var1) {
      return this.a(var1, false);
   }

   public fq a(aan var1, boolean var2) {
      if(var1 == null) {
         return null;
      } else {
         fq var3 = new fq(this.k, this.o, this.p - 0.30000001192092896D + (double)this.I(), this.q, var1);
         var3.c = 40;
         float var4 = 0.1F;
         float var5;
         if(var2) {
            ...
            var3.r = (double)(-gk.a(var6) * var5);
            var3.t = (double)(gk.b(var6) * var5);
            var3.s = 0.20000000298023224D;
         } else {
            var4 = 0.3F;
            var3.r = (double)(-gk.a(this.u / 180.0F * 3.1415927F) * gk.b(this.v / 180.0F * 3.1415927F) * var4);
            var3.t = (double)(gk.b(this.u / 180.0F * 3.1415927F) * gk.b(this.v / 180.0F * 3.1415927F) * var4);
            var3.s = (double)(-gk.a(this.v / 180.0F * 3.1415927F) * var4 + 0.1F);
            var4 = 0.02F;
   ...
   public void a(ady var1) {
      super.a(var1);
      no var2 = var1.n("Inventory");
      this.ap.b(var2);
      this.aB = var1.f("Dimension");
      this.aK = var1.o("Sleeping");
      this.a = var1.e("SleepTimer");
      this.aW = var1.h("XpP");
      this.aU = var1.f("XpLevel");
      this.aV = var1.f("XpTotal");
      if(this.aK) {
         this.aL = new uh(gk.c(this.o), gk.c(this.p), gk.c(this.q));
         this.a(true, true, false);
      }

      if(var1.c("SpawnX") && var1.c("SpawnY") && var1.c("SpawnZ")) {
         this.b = new uh(var1.f("SpawnX"), var1.f("SpawnY"), var1.f("SpawnZ"));
      }
   ...
   public void b(ady var1) {
      super.b(var1);
      var1.a("Inventory", (gh)this.ap.a(new no()));
      var1.a("Dimension", this.aB);
      var1.a("Sleeping", this.aK);
      var1.a("SleepTimer", (short)this.a);
      var1.a("XpP", this.aW);
      var1.a("XpLevel", this.aU);
      var1.a("XpTotal", this.aV);
      if(this.b != null) {
   ...
   public boolean a(md var1, int var2) {
      if(this.aT.a && !var1.g()) {
         ...
         if(this.bb() <= 0) {
            ...
            nn var3 = var1.a();
            if(var3 instanceof yy || var3 instanceof nm) {
               if(this.k.q == 0) {
                  var2 = 0;
               }
            ...
            if(var2 == 0) {
               ...
               nn var4 = var3;
               if(var3 instanceof nm && ((nm)var3).c != null) {
                  var4 = ((nm)var3).c;
               }

               if(var4 instanceof acq) {
                  this.a((acq)var4, false);
               }
   ...
   protected void a(acq var1, boolean var2) {
      if(!(var1 instanceof yd) && !(var1 instanceof ui)) {
         ...
         if(!(var1 instanceof yw) || this.B_()) {
            List var7 = this.k.a(yo.class, wu.b(this.o, this.p, this.q, this.o + 1.0D, this.p + 1.0D, this.q + 1.0D).b(16.0D, 4.0D, 16.0D));
   ...
   public void j(nn var1) {
      if(!var1.c(this)) {
         aan var2 = this.av();
         if(var2 != null && var1 instanceof acq) {
            var2.a((acq)var1);
            if(var2.a <= 0) {
               var2.a(this);
               this.aw();
   ...
   public void k(nn var1) {
      if(var1.k_()) {
         ...
         if(var1 instanceof acq) {
            var4 = ais.a(this.ap, (acq)var1);
            var3 += ais.b(this.ap, (acq)var1);
         }
         ...
         if(var2 > 0 || var4 > 0) {
            boolean var5 = this.M > 0.0F && !this.z && !this.p() && !this.H() && !this.a(aad.q) && this.j == null && var1 instanceof acq;
            if(var5) {
            ...
            if(var6) {
               if(var3 > 0) {
                  var1.c((double)(-gk.a(this.u * 3.1415927F / 180.0F) * (float)var3 * 0.5F), 0.1D, (double)(gk.b(this.u * 3.1415927F / 180.0F) * (float)var3 * 0.5F));
                  this.r *= 0.6D;
                  this.t *= 0.6D;
                  this.d(false);
               }
            ...
            aan var7 = this.av();
            if(var7 != null && var1 instanceof acq) {
               var7.a((acq)var1, this);
               if(var7.a <= 0) {
                  var7.a(this);
                  this.aw();
               }
            ...
            if(var1 instanceof acq) {
               if(var1.M()) {
                  this.a((acq)var1, true);
               }

               this.a(gv.w, var2);
               int var8 = ais.c(this.ap, (acq)var1);
               if(var8 > 0) {
                  var1.e(var8 * 4);
               }
            }
   ...
   public ci d(int var1, int var2, int var3) {
      if(!this.k.F) {
         ...
         double var4 = 8.0D;
         double var6 = 5.0D;
         List var8 = this.k.a(yy.class, wu.b((double)var1 - var4, (double)var2 - var6, (double)var3 - var4, (double)var1 + var4, (double)var2 + var6, (double)var3 + var4));
         if(!var8.isEmpty()) {
            return ci.f;
         }
      }
   ...
   public static uh a(xd var0, uh var1) {
      ca var2 = var0.z();
   ...
   public void i(double var1, double var3, double var5) {
      if(this.j == null) {
         int var7;
         if(this.a(acn.g)) {
            var7 = Math.round(gk.a(var1 * var1 + var3 * var3 + var5 * var5) * 100.0F);
            if(var7 > 0) {
               this.a(gv.q, var7);
               this.c(0.015F * (float)var7 * 0.01F);
            }
         } else if(this.H()) {
            var7 = Math.round(gk.a(var1 * var1 + var5 * var5) * 100.0F);
            if(var7 > 0) {
               this.a(gv.m, var7);
               this.c(0.015F * (float)var7 * 0.01F);
            }
   ...
   private void k(double var1, double var3, double var5) {
      if(this.j != null) {
         int var7 = Math.round(gk.a(var1 * var1 + var3 * var3 + var5 * var5) * 100.0F);
         if(var7 > 0) {
            if(this.j instanceof ama) {
               this.a(gv.r, var7);
               if(this.c == null) {
                  this.c = new uh(gk.c(this.o), gk.c(this.p), gk.c(this.q));
               } else if(this.c.b(gk.c(this.o), gk.c(this.p), gk.c(this.q)) >= 1000.0D) {
                  this.a((ajw)dp.q, 1);
               }
            } else if(this.j instanceof ep) {
               this.a(gv.s, var7);
            } else if(this.j instanceof qr) {
               this.a(gv.t, var7);
            }
         }
      }

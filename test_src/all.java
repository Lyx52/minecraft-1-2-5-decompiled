...
public class all extends tq {
   ...
   public void e() {
      ...
      if(this.H()) {
         ...
         if(this.e < 3.1415927F) {
            ...
            this.an = gk.a(var1 * var1 * 3.1415927F) * 3.1415927F * 0.25F;
         ...
         var1 = gk.a(this.r * this.r + this.t * this.t);
         ...
         this.an = gk.e(gk.a(this.e)) * 3.1415927F * 0.25F;
         if(!this.k.F) {
            this.r = 0.0D;
            this.s -= 0.08D;
   ...
   protected void y_() {
      ...
      if(this.cd > 100) {
         ...
         this.av = gk.b(var1) * 0.2F;
         this.aw = -0.1F + this.U.nextFloat() * 0.2F;
         this.ax = gk.a(var1) * 0.2F;
      }

...
public class aei extends qk {
      ...
      if(var1.o(var2, var3 + 1, var4) >= 9) {
         ...
         if(var5.nextInt((int)(25.0F / var6) + 1) == 0) {
            ...
            if(var7 < 7) {
               ...
               if(var1.a(var9, var3, var10) == 0 && (var11 == pb.aA.bO || var11 == pb.v.bO || var11 == pb.u.bO)) {
   ...
   public void i(xd var1, int var2, int var3, int var4) {
      var1.f(var2, var3, var4, 7);
   }

   private float j(xd var1, int var2, int var3, int var4) {
      float var5 = 1.0F;
   ...
   public int g(ali var1, int var2, int var3, int var4) {
      ...
      if(!var1.F) {
         ...
         for(int var9 = 0; var9 < 3; ++var9) {
            if(var1.r.nextInt(15) <= var5) {
               ...
               fq var14 = new fq(var1, (double)((float)var2 + var11), (double)((float)var3 + var12), (double)((float)var4 + var13), new aan(var8));
               var14.c = 10;
               var1.a((nn)var14);
            }
         }

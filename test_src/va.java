...
public class va extends nn {
   ...
   public va(xd var1, double var2, double var4, double var6) {
      super(var1);
      this.e = 0;
      this.a(0.25F, 0.25F);
   ...
   public void a(double var1, int var3, double var4) {
      ...
      float var10 = gk.a(var6 * var6 + var8 * var8);
      if(var10 > 12.0F) {
   ...
   public void J_() {
      ...
      if(!this.k.F) {
         ...
         if(this.e > 80 && !this.k.F) {
            this.A();
            if(this.am) {
               this.k.a((nn)(new fq(this.k, this.o, this.p, this.q, new aan(yr.bA))));
            } else {

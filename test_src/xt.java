...
public class xt extends vp {
   ...
   public xt() {
      try {
         ...
         BufferedReader var2 = new BufferedReader(new InputStreamReader(xt.class.getResourceAsStream("/title/splashes.txt"), Charset.forName("UTF-8")));
         String var3 = "";
   ...
   private void b(int var1, int var2, float var3) {
      ...
      for(int var6 = 0; var6 < var5 * var5; ++var6) {
         ...
         for(int var10 = 0; var10 < 6; ++var10) {
            ...
            GL11.glBindTexture(3553, this.p.p.b("/title/bg/panorama" + var10 + ".png"));
            var4.b();

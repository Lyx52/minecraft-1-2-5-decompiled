...
public class VorbisFile {
   ...
   public int bitrate(int var1) {
      if(var1 >= this.links) {
         ...
         return this.seekable?(int)Math.rint((double)((float)((this.offsets[var1 + 1] - this.dataoffsets[var1]) * 8L) / this.time_total(var1))):(this.vi[var1].bitrate_nominal > 0?this.vi[var1].bitrate_nominal:(this.vi[var1].bitrate_upper > 0?(this.vi[var1].bitrate_lower > 0?(this.vi[var1].bitrate_upper + this.vi[var1].bitrate_lower) / 2:this.vi[var1].bitrate_upper):-1));
      } else {
         long var2 = 0L;
   ...
   public int serialnumber(int var1) {
      return var1 >= this.links?-1:(!this.seekable && var1 >= 0?this.serialnumber(-1):(var1 < 0?this.current_serialno:this.serialnos[var1]));
   }
   ...
   public Info getInfo(int var1) {
      return this.seekable?(var1 < 0?(this.decode_ready?this.vi[this.current_link]:null):(var1 >= this.links?null:this.vi[var1])):(this.decode_ready?this.vi[0]:null);
   }

   public Comment getComment(int var1) {
      return this.seekable?(var1 < 0?(this.decode_ready?this.vc[this.current_link]:null):(var1 >= this.links?null:this.vc[var1])):(this.decode_ready?this.vc[0]:null);
   }

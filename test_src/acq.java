...
public abstract class acq extends nn {
   ...
   protected String bm = "/mob/char.png";
   ...
   public boolean a(Class var1) {
      return yd.class != var1 && ui.class != var1;
   }

   public void v() {}

   public boolean aU() {
      return this.f(gk.c(this.o), gk.c(this.p), gk.c(this.q));
   }
   ...
   public boolean m(nn var1) {
      return this.k.a(bo.b(this.o, this.p + (double)this.I(), this.q), bo.b(var1.o, var1.p + (double)var1.I(), var1.q)) == null;
   }
      ...
      if(this.bD == 20) {
         ...
         if(!this.k.F && (this.bP > 0 || this.aH()) && !this.bi()) {
            ...
            while(var1 > 0) {
               int var2 = bz.b(var1);
               var1 -= var2;
               this.k.a((nn)(new bz(this.k, this.o, this.p, this.q, var2)));
            }
         }
      ...
      if(this.k.F) {
         ...
         if(this.bx <= 0) {
            ...
            if(var4 != null) {
               ...
               if(var4 instanceof yw) {
                  this.bP = 60;
                  this.bO = (yw)var4;
               } else if(var4 instanceof yo) {
                  yo var5 = (yo)var4;
                  if(var5.G_()) {
                     this.bP = 60;
                     this.bO = null;
   ...
   public void a(nn var1, int var2, double var3, double var5) {
      this.al = true;
      float var7 = gk.a(var3 * var3 + var5 * var5);
      float var8 = 0.4F;
      this.r /= 2.0D;
      this.s /= 2.0D;
      this.t /= 2.0D;
   ...
   protected void e(float var1) {
      ...
      if(var2 > 0) {
         ...
         this.a(md.i, var2);
         int var3 = this.k.a(gk.c(this.o), gk.c(this.p - 0.20000000298023224D - (double)this.H), gk.c(this.q));
         if(var3 > 0) {
   ...
   public void a_(float var1, float var2) {
      ...
      if(this.H()) {
         ...
         if(this.z) {
            var8 = 0.54600006F;
            int var6 = this.k.a(gk.c(this.o), gk.c(this.y.b) - 1, gk.c(this.q));
            if(var6 > 0) {
         ...
         if(this.p()) {
            ...
            boolean var7 = this.V() && this instanceof yw;
            if(var7 && this.s < 0.0D) {
               this.s = 0.0D;
            }
         }
      ...
      this.bL = this.bM;
      var3 = this.o - this.l;
      double var11 = this.q - this.n;
      float var12 = gk.a(var3 * var3 + var11 * var11) * 4.0F;
      if(var12 > 1.0F) {
         var12 = 1.0F;
      }
   ...
   public void b(ady var1) {
      var1.a("Health", (short)this.bx);
      var1.a("HurtTime", (short)this.bA);
      var1.a("DeathTime", (short)this.bD);
      var1.a("AttackTime", (short)this.bE);
      if(!this.bS.isEmpty()) {
         no var2 = new no();
   ...
   public void a(ady var1) {
      ...
      this.bx = var1.e("Health");
      if(!var1.c("Health")) {
         this.bx = this.d();
      }

      this.bA = var1.e("HurtTime");
      this.bD = var1.e("DeathTime");
      this.bE = var1.e("AttackTime");
      if(var1.c("ActiveEffects")) {
         no var2 = var1.n("ActiveEffects");
   ...
   public void e() {
      ...
      if(this.bV > 0) {
         ...
         List var9 = this.k.a((nn)this, this.y.e(0.03125D, 0.0D, 0.03125D));
         if(var9.size() > 0) {
            double var10 = 0.0D;
      ...
      this.bt = var15;
      lv.a("push");
      List var4 = this.k.b((nn)this, this.y.b(0.20000000298023224D, 0.0D, 0.20000000298023224D));
      if(var4 != null && var4.size() > 0) {
         for(int var16 = 0; var16 < var4.size(); ++var16) {
            nn var6 = (nn)var4.get(var16);
            if(var6.d_()) {
               var6.g(this);
            }
         }
   ...
   protected void aD() {
      ...
      if(this.W()) {
         ...
         this.r -= (double)(gk.a(var1) * 0.2F);
         this.t += (double)(gk.b(var1) * 0.2F);
      }
   ...
   protected void y_() {
      ...
      if(this.U.nextFloat() < 0.02F) {
         yw var2 = this.k.a(this, (double)var1);
         if(var2 != null) {
            this.ay = var2;
   ...
   public void a(nn var1, float var2, float var3) {
      ...
      double var14 = (double)gk.a(var4 * var4 + var8 * var8);
   ...
   public bo j(float var1) {
      if(var1 == 1.0F) {
         return bo.b(this.o, this.p, this.q);
      } else {
         double var2 = this.l + (this.o - this.l) * (double)var1;
         double var4 = this.m + (this.p - this.m) * (double)var1;
         double var6 = this.n + (this.q - this.n) * (double)var1;
         return bo.b(var2, var4, var6);
      }
   }
   ...
   public bo k(float var1) {
      ...
      float var5;
      if(var1 == 1.0F) {
         var2 = gk.b(-this.u * 0.017453292F - 3.1415927F);
         var3 = gk.a(-this.u * 0.017453292F - 3.1415927F);
         var4 = -gk.b(-this.v * 0.017453292F);
         var5 = gk.a(-this.v * 0.017453292F);
         return bo.b((double)(var3 * var4), (double)var5, (double)(var2 * var4));
      } else {
         var2 = this.x + (this.v - this.x) * var1;
         var3 = this.w + (this.u - this.w) * var1;
         var4 = gk.b(-var3 * 0.017453292F - 3.1415927F);
         var5 = gk.a(-var3 * 0.017453292F - 3.1415927F);
         float var6 = -gk.b(-var2 * 0.017453292F);
         float var7 = gk.a(-var2 * 0.017453292F);
         return bo.b((double)(var5 * var6), (double)var7, (double)(var4 * var6));
      }
   }
   ...
   public void c(aan var1) {
      ...
      for(int var2 = 0; var2 < 5; ++var2) {
         bo var3 = bo.b(((double)this.U.nextFloat() - 0.5D) * 0.1D, Math.random() * 0.1D + 0.1D, 0.0D);
         var3.a(-this.v * 3.1415927F / 180.0F);
         var3.b(-this.u * 3.1415927F / 180.0F);
         bo var4 = bo.b(((double)this.U.nextFloat() - 0.5D) * 0.3D, (double)(-this.U.nextFloat()) * 0.6D - 0.3D, 0.6D);

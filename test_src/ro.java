...
public class ro extends vp {
   ...
   public void c() {
      this.s.clear();
      this.s.add(new z(1, this.q / 2 + 24, this.r / 2 + 74, 80, 20, cy.a("gui.done")));
   }
   ...
   protected void b(int var1, int var2, float var3) {
      ...
      int var6 = this.p.p.b("/terrain.png");
      int var7 = this.p.p.b("/achievement/bg.png");
      ...
      if(var32 != null) {
         ...
         if(this.x.b(var32)) {
            ...
            if(this.x.a(var32)) {
               this.u.a(cy.a("achievement.taken"), var26, var27 + var40 + 4, -7302913);
            }
         } else {
            var39 = Math.max(this.u.a(var36), 120);
            String var42 = cy.a("achievement.requires", new Object[]{cy.a(var32.c.i())});

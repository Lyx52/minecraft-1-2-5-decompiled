...
public class ame extends pb {
   ...
   public void l() {
      this.a(pb.x.bO, 5, 20);
      this.a(pb.aZ.bO, 5, 20);
      this.a(pb.at.bO, 5, 20);
      this.a(pb.J.bO, 5, 5);
      this.a(pb.K.bO, 30, 60);
      this.a(pb.an.bO, 30, 20);
      this.a(pb.am.bO, 15, 100);
      this.a(pb.X.bO, 60, 100);
      this.a(pb.ab.bO, 30, 60);
      this.a(pb.bu.bO, 15, 100);
   }
   ...
   public void a(xd var1, int var2, int var3, int var4, Random var5) {
      boolean var6 = var1.a(var2, var3 - 1, var4) == pb.bb.bO;
      if(var1.t instanceof ii && var1.a(var2, var3 - 1, var4) == pb.z.bO) {
         var6 = true;
      }
   ...
   private void a(xd var1, int var2, int var3, int var4, int var5, Random var6, int var7) {
      ...
      if(var6.nextInt(var5) < var8) {
         boolean var9 = var1.a(var2, var3, var4) == pb.am.bO;
   ...
   public void a(xd var1, int var2, int var3, int var4) {
      if(var1.t.g > 0 || var1.a(var2, var3 - 1, var4) != pb.ap.bO || !pb.be.a_(var1, var2, var3, var4)) {
         if(!var1.h(var2, var3 - 1, var4) && !this.h(var1, var2, var3, var4)) {
            var1.g(var2, var3, var4, 0);
         } else {
   ...
   public void b(xd var1, int var2, int var3, int var4, Random var5) {
      ...
      float var8;
      float var9;
      if(!var1.h(var2, var3 - 1, var4) && !pb.ar.g(var1, var2, var3 - 1, var4)) {
         if(pb.ar.g(var1, var2 - 1, var3, var4)) {
         ...
         if(pb.ar.g(var1, var2, var3, var4 - 1)) {
            for(var6 = 0; var6 < 2; ++var6) {
         ...
         if(pb.ar.g(var1, var2, var3 + 1, var4)) {
            for(var6 = 0; var6 < 2; ++var6) {
               var7 = (float)var2 + var5.nextFloat();

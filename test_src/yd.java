...
public class yd extends yy {
   ...
   public yd(xd var1) {
      super(var1);
      this.bm = "/mob/creeper.png";
      this.bT.a(1, new aje(this));
      this.bT.a(2, new ahe(this));
      this.bT.a(3, new fg(this, uo.class, 6.0F, 0.25F, 0.3F));
      ...
      this.bU.a(1, new amf(this, yw.class, 16.0F, 0, true));
   ...
   public void a(ady var1) {
      super.a(var1);
      this.ac.b(17, Byte.valueOf((byte)(var1.o("powered")?1:0)));
   }

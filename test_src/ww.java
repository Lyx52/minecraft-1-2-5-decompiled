...
public class ww extends fe {
   ...
   public void a(all var1, double var2, double var4, double var6, float var8, float var9) {
      super.a((acq)var1, var2, var4, var6, var8, var9);
   }

   protected void a(all var1, float var2, float var3, float var4) {
   ...
   protected void a(all var1, float var2) {}

   protected float b(all var1, float var2) {

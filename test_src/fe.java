...
public class fe extends um {
   ...
   public void a(acq var1, double var2, double var4, double var6, float var8, float var9) {
      GL11.glPushMatrix();
      GL11.glDisable(2884);
      this.a.h = this.c(var1, var9);
      if(this.b != null) {
         this.b.h = this.a.h;
      }
      ...
      try {
         float var10 = this.a(var1.be, var1.bd, var9);
         float var11 = this.a(var1.bg, var1.bf, var9);
         ...
         float var15 = var1.bL + (var1.bM - var1.bL) * var9;
         float var16 = var1.bN - var1.bM * (1.0F - var9);
         if(var1.bi()) {
            var16 *= 3.0F;
         }
         ...
         GL11.glEnable(3008);
         this.a.a(var1, var16, var15, var9);
         ...
         for(int var17 = 0; var17 < 4; ++var17) {
            var18 = this.b(var1, var17, var9);
            if(var18 > 0) {
               this.b.a(var1, var16, var15, var9);
               this.b.a(var1, var16, var15, var13, var11 - var10, var12, var14);
               if(var18 == 15) {
                  var19 = (float)var1.V + var9;
         ...
         GL11.glDisable(3553);
         es.a(es.a);
         if((var18 >> 24 & 255) > 0 || var1.bA > 0 || var1.bD > 0) {
            GL11.glDisable(3553);
            GL11.glDisable(3008);
            GL11.glEnable(3042);
            GL11.glBlendFunc(770, 771);
            GL11.glDepthFunc(514);
            if(var1.bA > 0 || var1.bD > 0) {
               GL11.glColor4f(var26, 0.0F, 0.0F, 0.4F);
               this.a.a(var1, var16, var15, var13, var11 - var10, var12, var14);

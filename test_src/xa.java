...
public class xa extends w {
   ...
   public void a(xd var1, int var2, int var3, int var4) {
      ...
      if(var1.a(var2, var3 - 1, var4) == pb.aU.bO && var1.a(var2, var3 - 2, var4) == pb.aU.bO) {
         if(!var1.F) {
      ...
      } else if(var1.a(var2, var3 - 1, var4) == pb.ai.bO && var1.a(var2, var3 - 2, var4) == pb.ai.bO) {
         boolean var5 = var1.a(var2 - 1, var3 - 1, var4) == pb.ai.bO && var1.a(var2 + 1, var3 - 1, var4) == pb.ai.bO;
         boolean var6 = var1.a(var2, var3 - 1, var4 - 1) == pb.ai.bO && var1.a(var2, var3 - 1, var4 + 1) == pb.ai.bO;
         if(var5 || var6) {
            var1.d(var2, var3, var4, 0);
            var1.d(var2, var3 - 1, var4, 0);
            var1.d(var2, var3 - 2, var4, 0);
   ...
   public boolean e(xd var1, int var2, int var3, int var4) {
      ...
      return (var5 == 0 || pb.m[var5].cd.i()) && var1.h(var2, var3 - 1, var4);
   }

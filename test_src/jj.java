...
public class jj extends pb {
   ...
   public int a(int var1, Random var2, int var3) {
      return this.bO == pb.I.bO?yr.m.bQ:(this.bO == pb.aw.bO?yr.n.bQ:(this.bO == pb.N.bO?yr.aW.bQ:this.bO));
   }

   public int a(Random var1) {
      return this.bO == pb.N.bO?4 + var1.nextInt(5):1;
   }

...
public class hx {
   ...
   public static int a(int var0, boolean var1) {
      if(!var1) {
         if(n.containsKey(Integer.valueOf(var0))) {
            return ((Integer)n.get(Integer.valueOf(var0))).intValue();
         } else {
            int var2 = a(b(var0, false));
            n.put(Integer.valueOf(var0), Integer.valueOf(var2));
            return var2;
         }
      } else {
   ...
   private static int a(boolean var0, boolean var1, boolean var2, int var3, int var4, int var5, int var6) {
      ...
      if(var0) {
         ...
         if(var3 == 0 && c(var6) == var4) {
            var7 = 1;
         } else if(var3 == 1 && c(var6) > var4) {
            var7 = 1;
         } else if(var3 == 2 && c(var6) < var4) {
            var7 = 1;
         }
      } else {
         var7 = b(var6, var4);
            ...
            if(var7 != null) {
               ...
               if(var8 > 0) {
                  ...
                  if(var6.b()) {
                     ...
                     var8 >>= var9;
                     var8 = (int)Math.round((double)var8 * var6.g());
                     if((var0 & 16384) != 0) {
                  ...
                  var2.add(new alg(var6.a(), var8, var9));
               }
            }
         }
      }
   ...
   static {
      l.put(Integer.valueOf(aad.l.a()), "0 & !1 & !2 & !3 & 0+6");
      b = "-0+1-2-3&4-4+13";
      l.put(Integer.valueOf(aad.c.a()), "!0 & 1 & !2 & !3 & 1+6");
      h = "+0+1-2-3&4-4+13";
      l.put(Integer.valueOf(aad.n.a()), "0 & 1 & !2 & !3 & 0+6");
      f = "+0-1+2-3&4-4+13";
      l.put(Integer.valueOf(aad.h.a()), "0 & !1 & 2 & !3");
      d = "-0-1+2-3&4-4+13";
      l.put(Integer.valueOf(aad.u.a()), "!0 & !1 & 2 & !3 & 2+6");
      e = "-0+3-4+13";
      l.put(Integer.valueOf(aad.t.a()), "!0 & !1 & !2 & 3 & 3+6");
      l.put(Integer.valueOf(aad.i.a()), "!0 & !1 & 2 & 3");
      l.put(Integer.valueOf(aad.d.a()), "!0 & 1 & !2 & 3 & 3+6");
      g = "+0-1-2+3&4-4+13";
      l.put(Integer.valueOf(aad.g.a()), "0 & !1 & !2 & 3 & 3+6");
      j = "+5-6-7";
      m.put(Integer.valueOf(aad.c.a()), "5");
      m.put(Integer.valueOf(aad.e.a()), "5");
      m.put(Integer.valueOf(aad.g.a()), "5");
      m.put(Integer.valueOf(aad.l.a()), "5");
      m.put(Integer.valueOf(aad.i.a()), "5");
      m.put(Integer.valueOf(aad.h.a()), "5");
      m.put(Integer.valueOf(aad.m.a()), "5");
      m.put(Integer.valueOf(aad.u.a()), "5");
      i = "-5+6-7";
      k = "+14&13-13";
      n = new HashMap();
